...
<div class="container-fluid">
	 <div class="row g-0">
	 	...
	 	<div class="col-7 g-4 main-content">
	 		<div class="container-fluid">
	 			<h3 class="text-light"><strong>My Account</strong></h3><br>

	 			<div class="card shadow p-2 mb-5 bg-body rounded-3">
	 				<div class="card-body">
	 					<div class="row">
	 						<div class="container-fluid">
	 							<label for="loan-range" class="form-label"><strong>Loan Amount</strong></label>
								<div class="range">
								  <input type="range" class="form-range" min="0" max="2000" step="500" data-id="loan-range" />
								</div><br><br>

								<label for="install-range" class="form-label"><strong>Installment Period</strong></label>
								<div class="range">
								  <input type="range" class="form-range" min="0" max="4" step="1" id="install-range" />
								</div><br><br>

								<div class="d-flex align-items-center justify-content-center">
									<button class="btn btn-primary btn-lg button-color shadow p-2 mb-4 rounded-pill w-50 ">Apply Now</button>
								</div>
	 						</div>
	 					</div>
	 				</div>
